-- Fix ambiguous column reference "recipient_id" in push notification trigger
-- The variable name recipient_id conflicts with the column name in the chats table
