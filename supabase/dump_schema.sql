...
BEGIN
  ...
  IF TG_OP = 'INSERT' THEN
    ...
    -- NOTE: This trigger-based push path is deprecated; push is sent via
    -- a Database Webhook (messages.INSERT -> send-push-notification edge
    -- function), so these settings are read at runtime and must be
    -- configured on the database (e.g. ALTER DATABASE ... SET ...).
