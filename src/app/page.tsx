...
export default function Home() {
  ...
  if (loading) {
    return (
      ...
      <div className="flex flex-col items-center gap-6">
        <Image src="/logo.png" alt="Telegraf" width={120} height={120} priority />
      </div>
      </div>
    );
  }
  ...
  return (
    <div
      ref={containerRef}
      className="relative min-h-[100dvh] w-full bg-[#050508] text-[#f7f8f8] overflow-hidden flex flex-col justify-between select-none"
    >
      {/* Dynamic Interactive Mouse Glow */}
      <div
        ref={glowRef}
      ...
      <footer className="relative z-40 max-w-5xl mx-auto w-full px-8 py-6 flex items-center justify-center text-xs text-gray-600 tracking-wide">
        <span>© {new Date().getFullYear()} Telegraf</span>
      </footer>
    </div>
  );
}
